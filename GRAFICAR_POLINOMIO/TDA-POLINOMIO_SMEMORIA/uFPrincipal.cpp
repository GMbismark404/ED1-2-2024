...
void __fastcall TForm1::Button2Click(TObject *Sender)
{
	...
	Canvas->Pen->Color = clGreen; // Color para los puntos de intersección
	for (int x = A * 20; x <= B * 20; x++) {
		...
		if (fabs(yf1 - yf2) < 0.01) {  // Si las funciones están muy cerca
			...
			// Establecer el tamaño de la fuente a 48
			Canvas->Font->Size = 48;
			// Mostrar las coordenadas del punto de intersección
