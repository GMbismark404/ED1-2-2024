...
{
	if (Edit3->Text == "A")
		conjA->MostrarConjunto(Form1->Canvas, 400, 200);
	else if (Edit3->Text == "B")
		conjB->MostrarConjunto(Form1->Canvas, 400, 200);
	else if (Edit3->Text == "C")
		conjC->MostrarConjunto(Form1->Canvas, 400, 200);
	else
		ShowMessage("");
}
//---------------------------------------------------------------------------
